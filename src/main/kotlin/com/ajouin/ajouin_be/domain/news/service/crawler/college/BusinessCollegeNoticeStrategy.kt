...
@Component
class BusinessCollegeNoticeStrategy : NoticeCrawlerStrategy {
    override val url: String = "https://biz.ajou.ac.kr/biz/community/notice.do"
    override val type: Type = Type.경영대학
