...
@Component
class PhysicsNoticeStrategy : NoticeCrawlerStrategy {
    override val url: String = "https://www2.ajou.ac.kr/physics/board/board01.jsp"
    override val type: Type = Type.물리학과
